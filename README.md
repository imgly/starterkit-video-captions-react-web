...
Enhance video creation by importing, customizing, and styling captions directly within the editor. Built with [CE.SDK](https://img.ly/creative-sdk) by [IMG.LY](https://img.ly), runs entirely in the browser with no server dependencies.

<p>
  <a href="https://img.ly/docs/cesdk/js/starterkits/video-captions-vcap01/">Documentation</a>
</p>
...
For complete integration guides and API reference, visit the [Video Editor Documentation](https://img.ly/docs/cesdk/js/starterkits/video-captions-vcap01/).
...
curl -O https://staticimgly.com/imgly/cesdk-web-examples-data/1.81.1-rc.0/starterkit-video-captions/demo-assets.zip
