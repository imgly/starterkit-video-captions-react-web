 ...
 *
 * This file configures low-level engine settings that control how the video editor
...
/**
 * Configure engine settings for the video editor.
 *
 ...
 * - Video-specific features (captions, timeline behavior)
...
export function setupSettings(engine: CreativeEngine): void {
  // ============================================================================
  // VIDEO FEATURE FLAGS
  // Enable video-specific capabilities
  // ============================================================================
  ...
  // Enable double-click to enter crop mode for images/videos
  ...
  // Hide page titles by default for video editing (timeline shows structure)
  ...
  engine.editor.setSetting('colorPicker/colorMode' as any, 'RGB');
  // #endregion
