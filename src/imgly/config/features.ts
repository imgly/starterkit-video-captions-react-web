...
export function setupFeatures(cesdk: CreativeEditorSDK): void {
  cesdk.feature.enable([
    ...
    'ly.img.shadow' /* Shadow parent feature */,
    ...
    'ly.img.group' /* Group parent feature */,
    ...
    'ly.img.fill' /* Fill parent feature */,
    'ly.img.fill.color' /* Solid color fill option */,
    'ly.img.fill.image' /* Image fill option */,
    'ly.img.fill.video' /* Video fill option */,
    'ly.img.stroke' /* Stroke parent feature */,
    ...
    'ly.img.shape.options' /* Shape Options parent feature */,
    ...
    'ly.img.combine' /* Combine parent feature */,
    ...
    'ly.img.position' /* Position parent feature */,
